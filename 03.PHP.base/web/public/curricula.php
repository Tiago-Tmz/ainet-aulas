                    ...
                    <div class="bg-white dark:bg-gray-900 p-6 rounded-xl font-base text-base text-gray-700 dark:text-gray-300">
                        <table class="table-auto border-collapse border border-gray-300">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="border-b-2 border-b-gray-400 dark:border-b-gray-500 border-e-2 border-e-gray-400 dark:border-e-gray-500" rowspan="3"></td>
                                ...
                                <tr>
                                    <td class="border-b-2 border-b-gray-400 dark:border-b-gray-500 border-e-2 border-e-gray-400 dark:border-e-gray-500">Systems Security</td>
                                    <td class="border-b-2 border-b-gray-400 dark:border-b-gray-500 border-e-2 border-e-gray-400 dark:border-e-gray-500"></td>
                                </tr>
                            </tbody>
                        </table>
