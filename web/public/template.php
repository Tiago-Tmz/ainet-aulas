                ...
                <div class="relative flex flex-col sm:flex-row px-6 sm:px-0 grow
                    ...
                    <div id="menu" class="grow flex flex-col sm:flex-row items-stretch
                        ...
                        <div class="flex me-0 sm:me-2">
                            <?php if ($scriptFileName == 'index.php') : ?>
                        ...
                        <!-- Menu Item: Courses -->
                        <div class="flex me-0 sm:me-2">
                            <?php if ($scriptFileName == 'courses.php') : ?>
                                <a class="grow inline-flex items-center h-16 px-3 pt-1
                                            text-sm font-medium 
                                            text-gray-900 dark:text-gray-50
                                            border-b-2 border-indigo-400 dark:border-indigo-500
                        ...
                        <div data-submenu="submenu_curricula" class="relative sm:static group flex flex-col me-0 sm:me-2" tabindex="8">
                            <?php if ($scriptFileName == 'curricula.php') : ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <div id="submenu_curricula" class="z-40 w-full items-center
                                        ...
                                        <?php foreach ($courses as $c) : ?>
                                            <?php if (strtolower($selectedCourse) == strtolower($c->abbreviation)) : ?>
